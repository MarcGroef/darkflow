DISCLAIMER:
This is a fork from Thtrieu. My addiditions (in progress) are mainly to provide an annotation pipeline in a ROS context.
The annotation part is in early development.
